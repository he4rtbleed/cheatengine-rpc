...
typedef VOID (__stdcall *CEP_LOADDTK32)(void);
...
typedef struct _ExportedFunctions
{
  ...
  PVOID DTKSuspendThread;			//   ...
  PVOID DTKResumeThread;			//   ...
  PVOID DTKSuspendProcess;			//   ...
  PVOID DTKResumeProcess;			//   ...
  PVOID KernelAlloc;				//   ...
